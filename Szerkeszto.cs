namespace Projekt
{
    class Szerkeszto
    {
        ...
        private static void MegjelenitPalya()
        {
        ...
        private static char ValasztMenubol(byte i)
        {
            char valasz;
            do
            {
        ...
        private static char[,] BetoltTerkepet(string palyaNeve)
        {
        ...
        private static char[,] GeneralTerkep()
        {
        ...
        private static void Berak(byte index)
        {
            Console.Clear();
            MegjelenitPalya();
